window.router = {
  ...
  async loadView(routeName, options = {}) {
    ...
    try {
      ...
      // Let the injected view complete layout + paint before its controller queries or measures DOM.
      // Two browser scheduling boundaries prevent fast route changes from racing view initialisation.
