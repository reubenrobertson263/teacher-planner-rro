window.tasksController = {
    ...
    async saveModalNote() {
        const titleRaw = document.getElementById('note-modal-title').value.trim();
        const bodyRaw = document.getElementById('note-modal-body').innerHTML;
        
        if (!titleRaw) return window.app.showToast("Title required");
        
        // Serialize to fit Prisma 'title' field limit
    ...
    insertImagePlaceholder() {
        // Real upload requires S3/Server config. Inserting visual placeholder for demo.
