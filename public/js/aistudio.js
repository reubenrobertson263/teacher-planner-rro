window.aistudioController = {
  toolkitCatalog: [
    ...
    ['Literacy & Language', [
      ['comprehension','Differentiated Comprehension'],['spag','SPaG Correction Generator'],['vocab','Tier 2 / Tier 3 Vocabulary'],['model_answer','WAGOLL / Model Answer'],['debate','Class Debate Motion'],['writing_frame','Writing Frame'],['summary','Student-Friendly Summary'],['glossary','Glossary Builder'],['command_words','Exam Command-Word Trainer']
    ]],
    ['Assessment & Marking', [
    ...
    ['Pastoral, Parents & Leadership', [
      ['reports','Report Comment Generator'],['email_praise','Positive Parent/Carer Email'],['email_angry','De-escalation Parent/Carer Email'],['newsletter','Newsletter Copy'],['parent_call','Parent Call Script'],['detention_script','Restorative Detention Script'],['pastoral_plan','Pastoral Intervention Plan'],['assembly','Assembly Script'],['policy','School Policy Draft'],['observation','Lesson Observation Feedback'],['sip','School Improvement Plan Actions'],['governor','Governor Briefing'],['cpd','CPD Session Plan'],['risk','Risk Assessment'],['meeting_agenda','Meeting Agenda'],['minutes','Meeting Minutes / Actions'],['line_management','Line-Management Agenda'],['intervention','Academic Intervention Plan']
    ]],
    ['Creative & Classroom Resources', [
      ['song','Mnemonic / Learning Song'],['timeline','Timeline Resource'],['case_study','Case Study Generator'],['scenario','Scenario / Role Play'],['worksheet','Worksheet + Answers'],['flashcards','Flashcard Set'],['dual_code','Dual-Coding Suggestions'],['compare','Comparison Matrix'],['data_response','Data-Response Activity']
    ]]
  ],
